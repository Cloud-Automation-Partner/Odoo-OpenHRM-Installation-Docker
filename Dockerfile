...
RUN echo 'deb http://apt.postgresql.org/pub/repos/apt/ bullseye-pgdg main' > /etc/apt/sources.list.d/pgdg.list \
    ...
    && rm -rf "$GNUPGHOME" \
    && apt-get update  \
    && apt-get -qq install --no-install-recommends -y postgresql-client libpq-dev \
...
ENV ODOO_EXTRA_ADDONS ${ODOO_EXTRA_ADDONS:-/opt/odoo/custom_addons}
